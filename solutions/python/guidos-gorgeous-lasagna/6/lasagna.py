...
def bake_time_remaining(elapsed_bake_time):
    """
    Return calculate remaining bake time in minutes. This function takes the actual minutes the lasagna has         been in the oven as an argument and returns how many minutes the lasagna still needs to bake 
...
def preparation_time_in_minutes(spend_prep_time):
    """
    Return preparation time in minutes. This function takes the number of layers you want to add to the lasagna     as an argument and returns how many minutes you would spend making them. Assume each layer takes 2 minutes 
    to prepare.  
    """
