...
def bake_time_remaining(elapsed_bake_time):
    ...
    as an argument and returns how many minutes the lasagna still needs to bake 
    based on the EXPECTED_BAKE_TIME
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    already spent baking and calculates the total elapsed minutes spent cooking 
    the lasagna.
    """
